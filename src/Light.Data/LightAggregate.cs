...
namespace Light.Data
{
    internal class LightAggregate<T, K> : AggregateBase<K>
    {
        ...
        {
            var queryCommand =
                _context.Database.QueryDynamicAggregate(_context, Model, _query, _having, _order, _region);
            return _context.QueryDataDefineReader<K>(Model.OutputDataMapping, _level, queryCommand.Command,
                queryCommand.InnerPage ? null : _region, queryCommand.State, null).GetEnumerator();
        }
        ...
        {
            var orderExpression =
                LambdaExpressionExtend.ResolveLambdaAggregateOrderByExpression(expression, OrderType.ASC, Model);
        ...
        {
            var orderExpression =
                LambdaExpressionExtend.ResolveLambdaAggregateOrderByExpression(expression, OrderType.DESC, Model);
            _order = orderExpression;
            return this;
        }
        ...
        public override List<K> ToList()
        {
            var queryCommand =
                _context.Database.QueryDynamicAggregate(_context, Model, _query, _having, _order, _region);
            return _context.QueryDataDefineList<K>(Model.OutputDataMapping, _level, queryCommand.Command,
                queryCommand.InnerPage ? null : _region, queryCommand.State, null);
        }
        ...
        public override K ElementAt(int index)
        {
            ...
            var queryCommand =
                _context.Database.QueryDynamicAggregate(_context, Model, _query, _having, _order, region);
            return _context.QueryDataDefineSingle<K>(Model.OutputDataMapping, _level, queryCommand.Command,
                queryCommand.InnerPage ? 0 : region.Start, queryCommand.State, null);
        }
        ...
        public override int SelectInsert<P>(Expression<Func<K, P>> expression)
        {
            ...
            var queryCommand =
                _context.Database.SelectInsertWithAggregate(_context, selector, Model, _query, _having, _order);
        ...
        public override IJoinTable<K, T1> Join<T1>(Expression<Func<T1, bool>> queryExpression,
            Expression<Func<K, T1, bool>> onExpression)
        {
        ...
        public override IJoinTable<K, T1> Join<T1>(IQuery<T1> query, Expression<Func<K, T1, bool>> onExpression)
        {
            ...
            return new LightJoinTable<K, T1>(this, JoinType.InnerJoin, queryBase, onExpression, _joinSetting,
                queryBase.JoinSetting);
        }

        public override IJoinTable<K, T1> LeftJoin<T1>(Expression<Func<T1, bool>> queryExpression,
            Expression<Func<K, T1, bool>> onExpression)
        {
            var lightQuery = new LightQuery<T1>(_context);
            if (queryExpression != null)
        ...
        public override IJoinTable<K, T1> LeftJoin<T1>(IQuery<T1> query, Expression<Func<K, T1, bool>> onExpression)
        {
            ...
            return new LightJoinTable<K, T1>(this, JoinType.LeftJoin, queryBase, onExpression, _joinSetting,
                queryBase.JoinSetting);
        }
        ...
        public override IJoinTable<K, T1> Join<T1>(IAggregate<T1> aggregate, Expression<Func<K, T1, bool>> onExpression)
        {
            ...
            return new LightJoinTable<K, T1>(this, JoinType.InnerJoin, aggregateBase, onExpression, _joinSetting,
                aggregateBase.JoinSetting);
        }

        public override IJoinTable<K, T1> LeftJoin<T1>(IAggregate<T1> aggregate,
            Expression<Func<K, T1, bool>> onExpression)
        {
            var aggregateBase = aggregate as AggregateBase<T1>;
            if (aggregateBase == null)
            ...
            return new LightJoinTable<K, T1>(this, JoinType.LeftJoin, aggregateBase, onExpression, _joinSetting,
                aggregateBase.JoinSetting);
        }

        public override IJoinTable<K, T1> RightJoin<T1>(IAggregate<T1> aggregate,
            Expression<Func<K, T1, bool>> onExpression)
        {
            var aggregateBase = aggregate as AggregateBase<T1>;
            if (aggregateBase == null)
            ...
            return new LightJoinTable<K, T1>(this, JoinType.RightJoin, aggregateBase, onExpression, _joinSetting,
                aggregateBase.JoinSetting);
        }
        ...
        public override IJoinTable<K, T1> Join<T1>(ISelect<T1> select, Expression<Func<K, T1, bool>> onExpression)
        {
            ...
            return new LightJoinTable<K, T1>(this, JoinType.InnerJoin, selectBase, onExpression, _joinSetting,
                selectBase.JoinSetting);
        }
        ...
        public override IJoinTable<K, T1> LeftJoin<T1>(ISelect<T1> select, Expression<Func<K, T1, bool>> onExpression)
        {
            ...
            return new LightJoinTable<K, T1>(this, JoinType.LeftJoin, selectBase, onExpression, _joinSetting,
                selectBase.JoinSetting);
        }
        ...
        public override async Task<List<K>> ToListAsync(CancellationToken cancellationToken = default)
        {
            var queryCommand =
                _context.Database.QueryDynamicAggregate(_context, Model, _query, _having, _order, _region);
            return await _context.QueryDataDefineListAsync<K>(Model.OutputDataMapping, _level, queryCommand.Command,
                queryCommand.InnerPage ? null : _region, queryCommand.State, null, cancellationToken);
        }
        ...
        public override async Task<K> ElementAtAsync(int index, CancellationToken cancellationToken = default)
        {
            ...
            var queryCommand =
                _context.Database.QueryDynamicAggregate(_context, Model, _query, _having, _order, region);
            return await _context.QueryDataDefineSingleAsync<K>(Model.OutputDataMapping, _level, queryCommand.Command,
                queryCommand.InnerPage ? 0 : region.Start, queryCommand.State, null, cancellationToken);
        }

        public override async Task<int> SelectInsertAsync<P>(Expression<Func<K, P>> expression,

...
namespace Light.Data
{
	...
	class LightJoinTable<T, T1> : IJoinTable<T, T1>
	{
		...
		{
			var selectable = new LightSelectJoin<T, T1, K> (_context, expression, _modelList, _maps, _query, _order, _distinct, _region, _level);
			return selectable;
		}
		...
		{
			var lightQuery = new LightQuery<T2> (_context);
	...
	class LightJoinTable<T, T1, T2> : IJoinTable<T, T1, T2>
	{
		...
		{
			var selectable = new LightSelectJoin<T, T1, T2, K> (_context, expression, _modelList, _maps, _query, _order, _distinct, _region, _level);
			return selectable;
		}
		...
		{
			var lightQuery = new LightQuery<T3> (_context);
			if (queryExpression != null) {
				lightQuery.Where (queryExpression);
			}
	...
	class LightJoinTable<T, T1, T2, T3> : IJoinTable<T, T1, T2, T3>
	{
		...
		{
			var selectable = new LightSelectJoin<T, T1, T2, T3, K> (_context, expression, _modelList, _maps, _query, _order, _distinct, _region, _level);
			return selectable;
		}
		...
		{
			var lightQuery = new LightQuery<T4> (_context);
			if (queryExpression != null) {
				lightQuery.Where (queryExpression);
			}
	...
	class LightJoinTable<T, T1, T2, T3, T4> : IJoinTable<T, T1, T2, T3, T4>
	{
		...
		{
			var selectable = new LightSelectJoin<T, T1, T2, T3, T4, K> (_context, expression, _modelList, _maps, _query, _order, _distinct, _region, _level);
			return selectable;
		}
		...
		{
			var lightQuery = new LightQuery<T5> (_context);
			if (queryExpression != null) {
				lightQuery.Where (queryExpression);
			}
	...
	class LightJoinTable<T, T1, T2, T3, T4, T5> : IJoinTable<T, T1, T2, T3, T4, T5>
	{
		...
		{
			var selectable = new LightSelectJoin<T, T1, T2, T3, T4, T5, K> (_context, expression, _modelList, _maps, _query, _order, _distinct, _region, _level);
			return selectable;
		}
		...
		{
			var lightQuery = new LightQuery<T6> (_context);
			if (queryExpression != null) {
				lightQuery.Where (queryExpression);
			}
	...
	class LightJoinTable<T, T1, T2, T3, T4, T5, T6> : IJoinTable<T, T1, T2, T3, T4, T5, T6>
	{
		...
		{
			var selectable = new LightSelectJoin<T, T1, T2, T3, T4, T5, T6, K> (_context, expression, _modelList, _maps, _query, _order, _distinct, _region, _level);
			return selectable;
		}
		...
		{
			var lightQuery = new LightQuery<T7> (_context);
			if (queryExpression != null) {
				lightQuery.Where (queryExpression);
			}
	...
	class LightJoinTable<T, T1, T2, T3, T4, T5, T6, T7> : IJoinTable<T, T1, T2, T3, T4, T5, T6, T7>
	{
		...
		{
			var selectable = new LightSelectJoin<T, T1, T2, T3, T4, T5, T6, T7, K> (_context, expression, _modelList, _maps, _query, _order, _distinct, _region, _level);
			return selectable;
		}
		...
		{
			var lightQuery = new LightQuery<T8> (_context);
			if (queryExpression != null) {
				lightQuery.Where (queryExpression);
			}
	...
	class LightJoinTable<T, T1, T2, T3, T4, T5, T6, T7, T8> : IJoinTable<T, T1, T2, T3, T4, T5, T6, T7, T8>
	{
		...
		{
			var selectable = new LightSelectJoin<T, T1, T2, T3, T4, T5, T6, T7, T8, K> (_context, expression, _modelList, _maps, _query, _order, _distinct, _region, _level);
			return selectable;
		}
		...
		{
			var lightQuery = new LightQuery<T9> (_context);
			if (queryExpression != null) {
				lightQuery.Where (queryExpression);
			}
	...
	class LightJoinTable<T, T1, T2, T3, T4, T5, T6, T7, T8, T9> : IJoinTable<T, T1, T2, T3, T4, T5, T6, T7, T8, T9>
	{
		...
		{
			var selectable = new LightSelectJoin<T, T1, T2, T3, T4, T5, T6, T7, T8, T9, K> (_context, expression, _modelList, _maps, _query, _order, _distinct, _region, _level);
			return selectable;
		}

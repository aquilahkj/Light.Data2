...
namespace Light.Data
{
	...
	/// Join table.
	/// </summary>		
	class LightSelectJoin<T, T1, K> : LightSelectJoin<K>
	{
	...
	/// Join table.
	/// </summary>		
	class LightSelectJoin<T, T1, T2, K> : LightSelectJoin<K>
	{
	...
	/// Join table.
	/// </summary>		
	class LightSelectJoin<T, T1, T2, T3, K> : LightSelectJoin<K>
	{
	...
	/// Join table.
	/// </summary>		
	class LightSelectJoin<T, T1, T2, T3, T4, K> : LightSelectJoin<K>
	{
	...
	/// Join table.
	/// </summary>		
	class LightSelectJoin<T, T1, T2, T3, T4, T5, K> : LightSelectJoin<K>
	{
	...
	/// Join table.
	/// </summary>		
	class LightSelectJoin<T, T1, T2, T3, T4, T5, T6, K> : LightSelectJoin<K>
	{
	...
	/// Join table.
	/// </summary>		
	class LightSelectJoin<T, T1, T2, T3, T4, T5, T6, T7, K> : LightSelectJoin<K>
	{
	...
	/// Join table.
	/// </summary>		
	class LightSelectJoin<T, T1, T2, T3, T4, T5, T6, T7, T8, K> : LightSelectJoin<K>
	{
	...
	/// Join table.
	/// </summary>		
	class LightSelectJoin<T, T1, T2, T3, T4, T5, T6, T7, T8, T9, K> : LightSelectJoin<K>
	{

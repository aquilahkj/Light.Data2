...
namespace Light.Data
{
    ...
    {
        private static readonly Dictionary<FieldInfo, GetValueHandler> mFieldGetHandlers =
            new Dictionary<FieldInfo, GetValueHandler>();

        private static readonly Dictionary<FieldInfo, SetValueHandler> mFieldSetHandlers =
            new Dictionary<FieldInfo, SetValueHandler>();

        private static readonly Dictionary<Type, ObjectInstanceHandler> mInstanceHandlers =
            new Dictionary<Type, ObjectInstanceHandler>();

        private static readonly Dictionary<MethodInfo, FastMethodHandler> mMethodHandlers =
            new Dictionary<MethodInfo, FastMethodHandler>();

        private static readonly Dictionary<PropertyInfo, GetValueHandler> mPropertyGetHandlers =
            new Dictionary<PropertyInfo, GetValueHandler>();

        private static readonly Dictionary<PropertyInfo, SetValueHandler> mPropertySetHandlers =
            new Dictionary<PropertyInfo, SetValueHandler>();
        ...
        {
            il.Emit(type.GetTypeInfo().IsValueType ? OpCodes.Unbox_Any : OpCodes.Castclass, type);
        }

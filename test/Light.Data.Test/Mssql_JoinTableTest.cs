...
{
    public class Mssql_JoinTableTest : BaseTest
    {
        public Mssql_JoinTableTest(ITestOutputHelper output) : base(output)
        {
        }
        ...
        public void TestCase_Aggregate_Join()
        {
...

            {
                ...
                var listAc = context.Query<TeMainTable>()
                      .Join(context.Query<TeSubTable>().GroupBy(x => new {
                          SubId = x.SubId,
                          Count = Function.Count(),
                      }), (x, y) => x.SubId == y.SubId)
                      .Select(
        ...
        public void TestCase_Select_Aggregate_Join()
        {
...

            {
                ...
                var listAc = context.Query<TeMainTable>().GroupBy(x => new {
                    SubId = x.SubId,
                    Count = Function.Count()
                }).Join(context.Query<TeSubTable>().Select(x => new {
                    x.SubId,
        ...
        #region version
        [Fact]
        public void TestCase_JoinBase_PageTakeSkip_Ver2012()
        {
